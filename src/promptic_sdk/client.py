...
class PrompticClient:
    ...
    def get_dataset(self, component_id: str, dataset_id: str) -> DatasetWithCases:
        """Get a dataset with its reusable cases."""
    ...
    def create_dataset_cases(
        ...
        component_id: str,
        dataset_id: str,
        cases: DatasetCaseInput | list[DatasetCaseInput],
    ) -> DatasetCaseList:
        """Create one or more structured dataset cases."""
        return self._post(
