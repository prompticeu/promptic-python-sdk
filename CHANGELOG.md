...
- Expanded CLI support with commands for runs, annotations, evaluations, and improved session-based authentication.
- Improved tracing, CLI login experience, and set correct default endpoint configuration.
- CLI now auto-selects workspace after login for smoother user workflow.
- Added support for typed models, new CLI commands, and deployed prompt management.
- Introduced AsyncPrompticClient for async capabilities and created a comprehensive README.
- Set up Python SDK repository with MIT license for open-source distribution.
